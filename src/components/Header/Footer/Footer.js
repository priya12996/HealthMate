    ...
    >
      ...
      <strong>
        <a
          ...
          href="https://github.com/priya12996"
          target="_blank"
          ...
          >
            <Grid sx={{ m: "auto" }} item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <a className="text-style" href="mailto:priyabhartikomal@gmail.com">
                  priyabhartikomal@gmail.com
                </a>
              </Stack>
              ...
              >
                ...
                <a className="text-style" href="mobile:8873891143">
                  +91 8873891143
                </a>
              </Stack>
            </Grid>
            ...
            <Grid item xs={12} sm={4}>
              ...
              >
                ...
                <a
                  className="text-style"
                  href="https://www.instagram.com/priya_10_73/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Priya on Instagram
              ...
              >
                ...
                <a
                  className="text-style"
                  href="https://github.com/priya1299"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Priya on GitHub
